...
public class NutritionController {
    ...
    public ResponseEntity<?> nutritionPlanSetup(@Valid @RequestBody NutritionPlanReq req) {
        try {
    ...
    public ResponseEntity<?> nutritionLogs(@Valid @RequestBody NutritionLogsReq req) {
        try {
    ...
    public ResponseEntity<?> dailyNutritionSummary(@Valid @RequestBody NutritionLogsReq req) {
        try {
